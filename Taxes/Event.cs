...
record Event(
    ...
    ///   - Notice that interests generated by security lending in the context of a Stock Yield Enhancement
    ///     Program (SYEP), while reported in the IBKR Interest section, are not affected by WHT. You can compare
    ///     the items under the "Interest" section of the report with the ones under the "Withholding Tax" section.
